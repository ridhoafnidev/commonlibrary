...
import com.app.commonlibrary.utils.commons.Logs
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        try {
            ...
            return constructor.newInstance(view)
             ...
             Logs.log("NoSuchMethodException ${e.message}")
            throw RuntimeException(e)
        } catch (e: IllegalAccessException) {
            Logs.log("IllegalAccessException: ${e.message}")
            throw RuntimeException(e)
        } catch (e: InstantiationException) {
            Logs.log("InstantiationException: ${e.message}")
            throw RuntimeException(e)
        } catch (e: InvocationTargetException) {
            Logs.log("InvocationTargetException: ${e.message}")
            throw RuntimeException(e)
        }
    }
